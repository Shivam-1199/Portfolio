...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Shivam Pokhariyal
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">I'm a passionate web developer/software engineer based in Navi Mumbai, a quick learner and easily adapt to new enviornment </p>
